...
export default async function AffiliateCommissionsPage({ searchParams }: { searchParams: Promise<{ page?: string }> }) {
    ...
    return (
        <div className="space-y-6 max-w-5xl mx-auto font-sans">
            <div>
                <h2 className="text-2xl font-bold text-zinc-100 mb-1 tracking-tight">Referrals</h2>
                <p className="text-zinc-500 text-sm font-medium">Track individual sales mapping your commissions.</p>
            </div>
