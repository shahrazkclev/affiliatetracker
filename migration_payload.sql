...
BEGIN
    ...
    VALUES ('ade4e10d-fd34-408a-928c-5d1e851bf689', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'tiktok khan', 'cleverpolytiktokzrp@gmail.com', 'cleverpolytiktokzrp@gmail.com', 'tiktok', 'active', 7033, 30, '2026-01-31T08:55:29.527714+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('83a1cda4-302b-499e-b2ae-f914ed3f162e', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'meta insta', 'metaclev@cleverpoly.store', 'metaclev@cleverpoly.store', 'meta', 'active', 2333, 30, '2026-01-29T16:32:37.704402+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('4e32a2f1-210e-44b4-be0d-13dbb2067d08', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Sheraz Yousaf', 'sherry3d08@gmail.com', 'sherry3d08@gmail.com', 'Sherry3D', 'active', 1, 30, '2026-01-26T14:11:50.110837+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    ...
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('bb2fad36-c554-45da-986f-e5f548cfb453', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Haris Khan', 'ask.haris193@gmail.com', 'ask.haris193@gmail.com', 'haris', 'active', 131, 30, '2025-12-30T19:32:48.581565+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    ...
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('e3991197-8a5d-4438-864f-f712db5fd29c', v_org_id, '22f20831-2278-4bfc-9e9b-9189b8f5690d', 'Fatima Sultan', 'askfatima.fusion@gmail.com', 'askfatima.fusion@gmail.com', 'fatima', 'active', 537, 40, '2025-10-29T17:00:45.587879+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('2f54d413-a64c-4e5b-8a32-cc84bc32f88b', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'chap1  course', 'chap1video@gmail.com', 'chap1video@gmail.com', 'ch1', 'active', 89, 30, '2025-10-25T20:37:06.230004+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('064e02af-9784-4971-8a15-d6f27c62246b', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'not your skills video', 'notyourskillsvideo@gmail.com', 'notyourskillsvideo@gmail.com', 'ntyskl', 'active', 18, 30, '2025-10-25T20:35:12.317017+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    ...
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('a7ca1a59-baa9-4457-a5d9-f57f6293a54d', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Shayan Khan', 'askshayan47@gmail.com', 'askshayan47@gmail.com', 'SHN', 'active', 162, 30, '2025-05-25T12:19:27.485312+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    ...
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('3c0fd591-ed86-4102-9074-7c63dcf6dcee', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'abdullah Shahzad', 'abihabdullah03@gmail.com', 'abihabdullah03@gmail.com', '3dbyabdull', 'active', 35, 30, '2025-03-21T00:44:49.916051+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('3dc412c5-a0c4-4234-89d5-042028a4b8ef', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Alan Wayne', 'alanwayne4940@gmail.com', 'alanwayne4940@gmail.com', 'Alan', 'active', 71, 30, '2025-03-06T09:41:07.775227+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('c6e7dc67-df7c-4572-aad1-c4120f743289', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Creative Sav', 'thecreativesav@gmail.com', 'thecreativesav@gmail.com', 'discount10sav', 'active', 329, 30, '2025-02-20T09:39:16.163684+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('4fe67adb-3238-459d-9ba4-2af945ed1242', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Haadi Mohammed', 'work.haadimohammed@gmail.com', 'work.haadimohammed@gmail.com', 'mafriend', 'active', 1238, 30, '2025-02-18T20:55:57.018098+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('3867c492-52ad-4c7d-a05f-7aa16664b539', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Angela Ryu', 'angelaryu@ryuxrstudio.com', 'angelaryu@ryuxrstudio.com', 'Ryuxrstudio', 'active', 63, 30, '2025-02-12T05:01:01.383969+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('713e1234-58aa-4456-b800-8d5912eaa269', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Abdul Ahad', 'abdulahadjanjua2022@gmail.com', 'abdulahadjanjua2022@gmail.com', 'AhadAninmates', 'active', 657, 30, '2025-01-29T14:39:53.162144+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    ...
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('db745625-1cf9-4aea-b85c-5eb24343a2fd', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Andy M', 'support@andym.digital', 'support@andym.digital', 'andymvis', 'active', 2933, 30, '2024-12-16T06:45:27.871701+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    ...
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('4a4de88a-4380-49a7-a0fd-a07078905da4', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Maniha Tahir', 'maniha.tahir@gmail.com', 'maniha.tahir@gmail.com', 'maniha', 'active', 244, 30, '2024-12-14T09:35:57.384437+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('af7b4478-24de-40c9-a71f-add463b2a505', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Ahmad ali', 'ask.productshade@gmail.com', 'ask.productshade@gmail.com', 'alf', 'active', 1868, 30, '2024-12-14T09:17:29.810923+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
    VALUES ('289b98ae-e8cf-471d-9593-65937bbd0bad', v_org_id, 'd63cb1ba-5277-4131-93bb-b92f2ac05254', 'Zaid Ali', 'askzaid133@gmail.com', 'askzaid133@gmail.com', 'jani', 'active', 3495, 30, '2024-12-14T08:48:45.942995+00:00')
    ON CONFLICT DO NOTHING;
    INSERT INTO affiliates (id, org_id, campaign_id, name, email, payout_email, referral_code, status, clicks, total_commission, created_at)
